...
public final class UnmuteButtonPill: UIButton {
    ...
    private let unmuteColor = UIColor(red: 242 / 255, green: 75 / 255, blue: 39 / 255, alpha: 1)
    ...
    public init(
        ...
        configure(backgroundColor: backgroundColor, unmuteIcon: unmuteIcon, title: title, layout: layout)
    }
    ...
    private func configure(
        ...
        if layout == .pill {
            ...
            label.textColor = unmuteColor
            label.attributedText = labelAttributedText(title, color: unmuteColor)
        ...
        let imageView = UIImageView(
            image: (unmuteIcon ?? UIImage(named: "MicOff", in: .module, compatibleWith: nil) ?? UIImage(systemName: "mic.slash.fill"))?
                .withRenderingMode(.alwaysTemplate)
        )
        imageView.translatesAutoresizingMaskIntoConstraints = false
        imageView.tintColor = unmuteColor
